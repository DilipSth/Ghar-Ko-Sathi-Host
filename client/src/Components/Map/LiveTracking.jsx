  ...
  const updatePosition = useCallback(
    async (position) => {
      try {
        ...
        // Emit location update for service providers
  ...
  useEffect(() => {
    ...
    const handleLocationUpdate = (data) => {
      try {
        ...
        // Handle service provider location updates for all roles
        if (data.userId && (user.role === "user" || user.role === "admin")) {
          const newPosition = {
